...
class Account {
    ...
    async me() { return await this.main.request('GET', '/account.me'); }

    async balances() { return await this.main.request('GET', '/account.balances'); }

    async submit_deposit() { return await this.main.request('POST', '/account.submitDeposit') }
